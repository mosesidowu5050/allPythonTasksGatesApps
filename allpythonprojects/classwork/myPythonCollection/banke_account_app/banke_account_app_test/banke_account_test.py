...
class MyTestCase(unittest.TestCase):
    def test_if_amount_is_zero(self):
        ...
        self.assertEqual(0.0, account.get_balance("0202"))
    ...
    def test_that_check_if_deposit_works_properly(self):
        ...
        self.assertEqual(account.get_balance("0202"), 1000.00)
    ...
    def test_that_checks_withdraw_works_properly(self):
        ...
        self.assertEqual(account.get_balance("0202"), 500.00)
    ...
    def test_that_checks_if_transfer_works_properly(self):
        ...
        self.assertEqual(dayo.get_balance("0202"), 500.00)
        self.assertEqual(bode.get_balance("9230"), 500.00)
    ...
    def test_checks_if_transfer_works_properly(self):
        ...
        dayo.deposit("0202", 1000.00)
        dayo.transfer("0202", ayo, 500.00)
        self.assertEqual(dayo.get_balance("0202"), 500.00)
        self.assertEqual(ayo.get_balance("9239"), 500.00)
    ...
    def test_throws_exception_when_transfer_details_is_invalid(self):
        with self.assertRaises(ValueError):
            ...
            ayo = atm.create_account("Ayo", "Lawson", "9239")
            dayo.deposit("0202", 1000.00)
            dayo.transfer(None, None, 500.00)
    ...
    def test_that_get_balance_works_properly(self):
        ...
        self.assertEqual(dayo.get_balance("0202"), 1000.00)
        self.assertEqual(bode.get_balance("9230"), 950.00)
    ...
    def test_throws_exceptions_if_get_balance_details_not_valid(self):
        with self.assertRaises(ValueError):
            ...
            self.assertEqual(dayo.get_balance("0202"), 1000.00)
            self.assertEqual(ayo.get_balance(None), 950.00)
    ...
    def test_that_change_pin_works_perfectly(self):
        ...
        self.assertEqual(bode.get_balance("0001"), 1000.00)
